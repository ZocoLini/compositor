...
class TiledWindowManager : public miral::MinimalWindowManager
{
  public:
    ...
    void
    advise_adding_to_workspace(std::shared_ptr<Workspace> const& workspace,
                               std::vector<Window> const& windows) override;
    void
    advise_removing_from_workspace(std::shared_ptr<Workspace> const& workspace,
                                   std::vector<Window> const& windows) override;
    ...
    void
    handle_modify_window(WindowInfo& window_info,
                         WindowSpecification const& modifications) override;
  ...
  private:
    ...
    std::vector<miral::Window> get_workspace_windows(std::shared_ptr<miral::Workspace> const& workspace);
